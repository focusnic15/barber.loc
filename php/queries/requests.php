...
$requests = [];
$query = "SELECT request.request_id as request_id, clients.id_clients as clients_id, clients.name as client_name, clients.phone as client_phone, request.date as request_date, service.name as service_name,
